    ...
    switch($action) {
      case 'install': 
        try {
          ...
          $this->db->ExecuteQuery(self::SQL('insert content'), array('sport', 'news', 'Zlatan är en jävel på att dribbla', 'test.png', "Zlatan är helt galen, tycker alla barnen i Bullerbyn! Zlatan är helt galen, tycker alla barnen i Bullerbyn! Zlatan är helt galen, tycker alla barnen i Bullerbyn! Zlatan är helt galen, tycker alla barnen i Bullerbyn!", 'plain', $this->user['id']));
          $this->db->ExecuteQuery(self::SQL('insert content'), array('sport', 'news', 'Foppa gillar inte ens hockey längre', 'test.png', "Foppa berättar för oss i en exklusiv intervju att han hatar hockey och att han tänker springa in i väggen tio gånger. Foppa gillar inte ens hockey längre', Foppa berättar för oss i en exklusiv intervju att han hatar hockey och att han tänker springa in i väggen tio gånger.", 'plain', $this->user['id']));
          $this->db->ExecuteQuery(self::SQL('insert content'), array('sport', 'news', 'Curlingtanterna vinner tantligan i år igen!', 'test.png', "Stina gjorde två mål och firade med tre fina bakåtvolter.", 'plain', $this->user['id']));
          ...
          $this->db->ExecuteQuery(self::SQL('insert content'), array('local', 'news', 'En häst hjälpte en hel by', 'test.png', "Alla barnen i bullerbyn fick en hästsko av hästen! Alla barnen i bullerbyn fick en hästsko av hästen! Alla barnen i bullerbyn fick en hästsko av hästen!", 'plain', $this->user['id']));
          
          $this->db->ExecuteQuery(self::SQL('insert content'), array('entertainment', 'forum', 'Zlatan är en jävel på att dribbla', 'test.png', "Zlatan är helt galen, tycker alla barnen i Bullerbyn! Zlatan är helt galen, tycker alla barnen i Bullerbyn! Zlatan är helt galen, tycker alla barnen i Bullerbyn! Zlatan är helt galen, tycker alla barnen i Bullerbyn!", 'plain', $this->user['id']));
          $this->db->ExecuteQuery(self::SQL('insert content'), array('entertainment', 'forum', 'Foppa gillar inte ens hockey längre', 'test.png', "Foppa berättar för oss i en exklusiv intervju att han hatar hockey och att han tänker springa in i väggen tio gånger. Foppa gillar inte ens hockey längre', Foppa berättar för oss i en exklusiv intervju att han hatar hockey och att han tänker springa in i väggen tio gånger.", 'plain', $this->user['id']));
          $this->db->ExecuteQuery(self::SQL('insert content'), array('entertainment', 'forum', 'Curlingtanterna vinner tantligan i år igen!', 'test.png', "Stina gjorde två mål och firade med tre fina bakåtvolter.", 'plain', $this->user['id']));
          ...
          $this->db->ExecuteQuery(self::SQL('insert content'), array('local', 'forum', 'En häst hjälpte en hel by', 'test.png', "Alla barnen i bullerbyn fick en hästsko av hästen! Alla barnen i bullerbyn fick en hästsko av hästen! Alla barnen i bullerbyn fick en hästsko av hästen!", 'plain', $this->user['id']));
